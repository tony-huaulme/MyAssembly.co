...
const whatsappShareUrl = `https://wa.me/?text=${encodeURIComponent(shareLink)}`;
...
<Dialog v-model:visible="visible" v-if="activeProject" modal :header="`Share link for : ${activeProject.project_name || '...'}`" :style="{ width: '25rem' } " class="p-component">
    ...
    <div class="flex items-center gap-1 mb-4">
        ...
        <TextArea id="username" class="flex-auto" autocomplete="off" :value="shareLink" :class="copiedMessage != '' ? 'messagecopied' : ''"/>
