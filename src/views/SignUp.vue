<template>
    ...
    <div class="flex h-screen justify-center md:p-5">
        ...
        <div class="md:w-1/2 h-fill w-fill md:max-w-xl flex flex-column justify-center relative" style="background-color: var(--p-content-background);">
            ...
            <div class="w-fill flex flex-column items-center">
                ...
                <div class="w-2/3 max-w-md mt-10 flex flex-column justify-center ">
                    ...
                    <div v-else class="flex flex-col gap-2">
                        ...
                        <InputText @keydown.enter="goToNextSignupStep" id="password" v-model="password" type="password" />
                    </div>


                    <Button :label="signupIndex === 0 ? 'Continue' :  signupPage ? 'Create Account' : 'Login'" @click="goToNextSignupStep"
            ...
            <p class="flex flex-column items-center">{{ signupPage ?  'Have an accout? ' : "Don't have an account? " }}<a class="underline" @click="signupPage = !signupPage">{{ signupPage ? ' SignIn' : ' SignUp' }}</a></p>
            <!-- Navigation -->
